...
public class Opthalmology extends JFrame implements ActionListener {
    ...
    public Opthalmology() {
        ...
        // First Doctor
        rd1 = new JRadioButton("Name : Dr. Md. Abul Kalam Azad");
        ...
        label2 = new JLabel("Specialization : Opthalmology");
        ...
        // Second Doctor
        rd2 = new JRadioButton("Name : Dr. Shamima Sultana");
        rd2.setBounds(600, 130, 700, 100);
        rd2.setFont(f2);
        rd2.setOpaque(false);
        panel.add(rd2);

        label5 = new JLabel("Specialization : Opthalmology");
        label5.setBounds(620, 190, 700, 100);
        label5.setFont(f2);
        panel.add(label5);

        label6 = new JLabel("Time : 6 PM");
        label6.setBounds(620, 250, 700, 100);
        label6.setFont(f2);
        panel.add(label6);

        label7 = new JLabel("Consultation fees : 1000 BDT");
    ...
    public void actionPerformed(ActionEvent me) {
        ...
        if (me.getSource() == bt1) {
            ...
            if (rd1.isSelected()) {
                selectedDoctor = "Dr. Md. Abul Kalam Azad";
                selectedFee = 1300;
            } else if (rd2.isSelected()) {
                selectedDoctor = "Dr. Shamima Sultana";
                selectedFee = 1000;
            }
