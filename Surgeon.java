...
public class Surgeon extends JFrame implements ActionListener {
    ...
    public Surgeon() {
        ...
        // First Doctor
        rd1 = new JRadioButton("Name : Prof. Dr. AKM Fazlul Haque");
        ...
        label2 = new JLabel("Specialization : General Surgery");
        ...
        label4 = new JLabel("Consultation fees : 1600 BDT");
        label4.setBounds(100, 310, 700, 100);
        label4.setFont(f2);
        panel.add(label4);

        // Second Doctor
        rd2 = new JRadioButton("Name : Prof. Dr. Ruksana Parvin");
        rd2.setBounds(580, 130, 700, 100);
        rd2.setFont(f2);
        rd2.setOpaque(false);
        panel.add(rd2);

        label5 = new JLabel("Specialization : General Surgery");
        label5.setBounds(600, 190, 700, 100);
        label5.setFont(f2);
        panel.add(label5);

        label6 = new JLabel("Time : 8 PM");
        label6.setBounds(600, 250, 700, 100);
        label6.setFont(f2);
        panel.add(label6);

        label7 = new JLabel("Consultation fees : 1500 BDT");
    ...
    public void actionPerformed(ActionEvent me) {
        ...
        if (me.getSource() == bt1) {
            ...
            if (rd1.isSelected()) {
                selectedDoctor = "Prof. Dr. AKM Fazlul Haque";
                selectedFee = 1600;
            } else if (rd2.isSelected()) {
                selectedDoctor = "Prof. Dr. Ruksana Parvin";
                selectedFee = 1500;
            }
